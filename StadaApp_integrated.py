...
finalpos = 7		#final position of the motor
...
class Controller():
	...
	def measure_weight(self):									# Measures weight from a load and call handle_start()
		...
		root.after(500, self.measure_weight)
...
# --- WIDGETS ---
		...
		self.frames = {}
		login_frame = LoginFrame(container, self, controller)
		dashboard_frame = DashboardFrame(container, self,controller)
		preview_frame = PreviewFrame(container, self, controller)
		confirmation_frame = ConfirmationFrame(container,self, controller)
...
# --- VARIABLES ---
		...
		self.image = Image.open("stada_logo.png")
...
# --- VARIABLES ---
		...
		image = Image.open("stada_logo.png")
...
# --- WIDGETS ---
		...
		photo_preview = ttk.Label(image_frame, image = self.preview, padding = 20)
...
root.after(500, controller.measure_weight)
